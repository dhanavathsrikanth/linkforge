...
--> statement-breakpoint
ALTER TABLE "workspaces" ADD COLUMN "dodo_billing_cycle_anchor" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "workspaces" ADD COLUMN "dodo_customer_id" text;--> statement-breakpoint
ALTER TABLE "workspaces" ADD COLUMN "plan_updated_at" timestamp with time zone;--> statement-breakpoint
...
ALTER TABLE "usage_overrides" ADD CONSTRAINT "usage_overrides_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "billing_events_workspace_idx" ON "billing_events" USING btree ("workspace_id");--> statement-breakpoint
CREATE INDEX "billing_events_dodo_id_idx" ON "billing_events" USING btree ("dodo_event_id");--> statement-breakpoint
CREATE INDEX "subscriptions_workspace_idx" ON "subscriptions" USING btree ("workspace_id");--> statement-breakpoint
CREATE INDEX "subscriptions_dodo_id_idx" ON "subscriptions" USING btree ("dodo_subscription_id");--> statement-breakpoint
ALTER TABLE "workspaces" ADD CONSTRAINT "workspaces_dodo_customer_id_unique" UNIQUE("dodo_customer_id");