...
export async function GET(req: Request) {
  ...
  try {
    ...
    const shaped = {
      ...
      iosBundleId: link.iosBundleId ?? null,
      androidPackageName: link.androidPackageName ?? null,
      sha256CertFingerprints: link.sha256CertFingerprints ?? null,
      universalLinksEnabled: link.universalLinksEnabled,
      appLinksEnabled: link.appLinksEnabled,
