  ...
  try {
    ...
    const [link] = await db
      ...
      .values({
        ...
        uriScheme: v.smartRouting?.uriScheme ?? null,
        iosAppStoreId: v.smartRouting?.iosAppStoreId ?? null,
        androidPlayStoreId: v.smartRouting?.androidPlayStoreId ?? null,
        iosBundleId: v.smartRouting?.iosBundleId ?? null,
        androidPackageName: v.smartRouting?.androidPackageName ?? null,
