    ...
    <PopoverPrimitive.Portal>
      ...
      >
        <PopoverPrimitive.Popup
          ...
          className={cn(
            "relative w-full max-w-[calc(100%-1.5rem)] sm:max-w-[640px] max-h-[90vh] overflow-hidden rounded-2xl bg-popover shadow-2xl shadow-black/10 ring-1 ring-foreground/5 duration-150 outline-none pointer-events-auto data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95",
            className
          )}
          {...props}
        >
